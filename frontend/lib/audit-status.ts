...
export const ACTIVITY_TYPE_LABELS: Record<ActivityType, string> = {
  ...
  SHIPMENT_AWB_ASSIGNED: "AWB assigned",
  SHIPMENT_PICKUP_SCHEDULED: "Pickup scheduled",
  SHIPMENT_LABEL_GENERATED: "Label generated",
...
export const ACTIVITY_TYPE_COLORS: Record<ActivityType, string> = {
  ...
  PAYMENT_LINK_CREATED: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
  PAYMENT_LINK_CANCELLED: "bg-red-500/10 text-red-600 dark:text-red-400",
  SHIPMENT_AWB_ASSIGNED: "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400",
  SHIPMENT_PICKUP_SCHEDULED: "bg-blue-500/10 text-blue-600 dark:text-blue-400",
  SHIPMENT_LABEL_GENERATED: "bg-sky-500/10 text-sky-600 dark:text-sky-400",
